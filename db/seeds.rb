...
user2 = User.create!(email: "kyrillr@gmail.com",
    ...
    bio: "I'm a professional dancer from London with lots of teaching experience. I also worked as a choreographer for 10 years across the world. I recently became a certified yoga teacher (YTTC 200 hrs) in India",
...
user4 = User.create!(email: "jorisk@gmail.com",
    ...
    bio: "I'm junior professional boxer. I teach box, crossfit and kickbox for 3 years full time, sometimes I need help with subbing.",
...
user5 = User.create!(email: "marias@gmail.com",
    ...
    available: true,
    address: "Amsterdam",
    subjects: [subject_pilates, subject_yoga, subject_bodybalance],
...
user6 = User.create!(email: "kareng@gmail.com",
    ...
    bio: "I'm am enthusiastic part-time yoga teacher from Belgium, specialised in Yin and Vinyasa yoga. I have a strong focus on injury prevention and anatomy. I'm also a certified Pilates teacher. I have 5 years of teaching experience.",
    website_url: "karen-workouts.com",
    facebook_url: "facebook.com",
    instagram_url: "instagram.com",
    available: false,
    address: "Amsterdam",
    subjects: [subject_yoga, subject_pilates],
...
lesson25 = Lesson.create(start_time: DateTime.strptime("18:30", "%H:%M"),
    start_date: DateTime.strptime("11/26/2018", "%m/%d/%Y"),
    duration: 75,
    price: 30,
    address: "Amsterdam",
...
lesson26 = Lesson.create(start_time: DateTime.strptime("18:30", "%H:%M"),
    start_date: DateTime.strptime("12/03/2018", "%m/%d/%Y"),
    duration: 60,
    price: 30,
    address: "Amsterdam",
    description: "Hatha Yoga for regular students needs a substitute teacher in Buddha Studio, no music for this class.",
...
lesson27 = Lesson.create(start_time: DateTime.strptime("18:30", "%H:%M"),
    start_date: DateTime.strptime("12/10/2018", "%m/%d/%Y"),
    duration: 60,
    price: 30,
    address: "Amsterdam",
    description: "Hatha Yoga for regular students needs a substitute teacher in Buddha Studio, no music for this class.",
...
lesson28 = Lesson.create(start_time: DateTime.strptime("18:30", "%H:%M"),
    start_date: DateTime.strptime("12/02/2018", "%m/%d/%Y"),
    duration: 60,
    price: 30,
    address: "Amsterdam",
...
lesson29 = Lesson.create(start_time: DateTime.strptime("18:30", "%H:%M"),
    start_date: DateTime.strptime("12/09/2018", "%m/%d/%Y"),
    duration: 60,
    price: 30,
    address: "Amsterdam",
    description: "Pilates class for beginners needs a substitute teacher in Studio Pilates, Amsterdam. You need to open and close the studio, more details in PM.",
